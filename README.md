...
This color combination was carefully chosen to ensure a professional look and high readability.

### Accessibility:

Accessibility was a key consideration throughout development:

- HTML and CSS have been validated using the W3C Validator.
- The website follows modern web standards and semantic markup practices.
- Colour contrast ratios exceed **5.6:1**, ensuring content remains readable and accessible for users with visual impairments.
- Responsive layouts provide an optimal experience across desktop, tablet, and mobile devices.
